...
export const BannerSection = () => {
  return (
    ...
    <div className="flex max-w-[1440px] justify-center mx-auto">
      <div className="flex items-center px-5 justify-center flex-wrap gap-32">
        <div className="flex flex-col gap-8  xl:w-[469px]">
          <h1 className="title_text !leading-[59.52px] !text-[48px] xl:!text-start">
            This area is for big heading text for hero section
          </h1>
          <p className="description_text !text-xl !leading-8 text-center xl:!text-start">
        ...
        <div
         ...
         h-[320px] sm:h-[616px] xl:h-[668px] bg-primary-imageTestColor rounded-xl"
        >
          {/* Image here */}
        </div>
      </div>
