...
export const Consultation = () => (
  <div className="main_consalt w-full mx-auto   px-5 !mt-16 md:!mt-10 lg:!mt-[160px]  flex justify-center max-w-screen-xl items-center">
    <div className="inner-div_consalt  lg:w-[1161px] relative sm:w-[613px] w-[325px] lg:h-[478px]  sm:h-[325px]  h-[164px]  sm:rounded-[72px] rounded-[28px] flex flex-col items-center justify-center">
      <OptimizedImage src={second3DLogo} className="!w-[70px] !h-[62.88px]  sm:!w-[139.06px] sm:!h-[124.92px] xl:!w-[299px] xl:!h-[285px] left-logo absolute bottom-[-20px] sm:bottom-[-60px] left-[-20px] sm:left-[-60px]" />
      ...
      <OptimizedImage src={first3DLogo} className="!w-[69px] !h-[70px] right-logo sm:!w-[137.08px] sm:!h-[139.06px] xl:!w-[305px] xl:!h-[278px] absolute top-[-20px] sm:top-[-60px] right-[-20px] sm:right-[-60px]" />
    </div>
  </div>
)
