...
const Card = ({ title, description, src, i, number }) => {
  ...
  return (
    <div
      className={`px-6 !h-[141.45px] sm:!h-[273.65px] lg:!h-[380px] mt-24 mb-[500px] sm:!mt-20 sm:!mb-96  md:!mt-10 md:!mb-52 flex items-center justify-center sticky top-0`}
    >
      <div
        style={cardStyle}
        className={`flex flex-col relative overflow-hidden justify-center items-start h-auto lg:h-[340px] border rounded-[25px] p-6 md:p-[80px] transform origin-top `}
      >
        <OptimizedImage className={"w-[21.1px] h-[29.07px] md:h-auto md:w-auto"} src={src} />
