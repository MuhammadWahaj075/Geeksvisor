...
//       <div className="project_scroll_container">
//         <div className="project_scroll_content">
//           {projects.map((project) => (
//             <div
//               key={project.id}
//               className="project_cards flex justify-center flex-col lg:flex-row items-center xl:justify-between flex-wrap gap-[88px] mb-10 lg:gap-52"
//             >
