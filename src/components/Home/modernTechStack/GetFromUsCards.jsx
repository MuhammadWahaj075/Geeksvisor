...
export const Card = ({ card }) => (
  ...
  >
    ...
    <div className="grid place-content-center gap-4">
      ...
      <p className="text-[12px] sm:text-[16px] lg:text-[18px] w-[278px]  sm:!w-[360px] text-center sm:text-start lg:w-[360px] text-secondary-light opacity-[60%] leading-[14.52px] sm:leading-[26px] font-normal">
        {card?.description}
      </p>
    </div>
  </div>
