  ...
  <div className="mt-[85px] w-full">
    <div className="flex max-w-[1440px] justify-center mx-auto">
      <div className="flex items-center px-5 justify-center flex-wrap gap-10 lg:gap-60">
        <div className="flex flex-col !max-w-[616px] gap-8  xl:w-[469px]">
          <h1 className="title_text !leading-[19.84px] mx-auto max-w-[350px] sm:max-w-[616px]
           sm:!leading-[48px] lg:!leading-[56px] !text-[16px] sm:!text-[32px] xl:!text-[48px] xl:!text-start">
            {aboutBannerMockData.title}
          </h1>
          <p className="description_text !text-xs sm:!text-[14px] lg:!text-xl !leading-[14.52px] sm:!leading-[22px] lg:!leading-8 text-center xl:!text-start">
