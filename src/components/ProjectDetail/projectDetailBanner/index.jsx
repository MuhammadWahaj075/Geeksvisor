  ...
  return (
    <div className="mt-24">
      <div className="flex items-center gap-10 justify-between flex-wrap px-5">
        ...
        <div className="flex order-2 lg:order-1 flex-row-reverse items-center w-full lg:items-end lg:justify-end lg:w-auto justify-between lg:flex-col gap-6">
        ...
        <div className="flex order-1 lg:order-2 bg-primary-imageTestColor w-[1280px] h-[568px] rounded-xl" />
      </div>
    </div>
  );
};
